...
const MAX_SPHERE_ENEMIES = 2;
const PLAYER_SIZE = 0.8;
const PLAYER_DAMAGE = 10;
const PLAYER_DEATH_DURATION = 1.5;
const CONE_ENEMY_HEALTH = 9;
const SPHERE_ENEMY_HEALTH = 25;
...
const SHIELD_STUN_DURATION = 1.5;
const REFLECTED_BULLET_SPEED_MULTIPLIER = 2.5;
...
const PLAYER_INVINCIBILITY_DURATION = 0.3;
