...
export const ATTACK_SWIPE_DELTA = 10;
...
export const ENERGY_COST_ATTACK = 25;
export const ENERGY_COST_HARD_ATTACK = 70;
export const ENERGY_COST_SHOTGUN = 30;
export const ENERGY_COST_SHIELD = 50;
export const ENERGY_REGEN_RATE = 5;
export const SHOTGUN_AMMO = 10;
